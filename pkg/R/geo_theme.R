...
geo_theme <- function(title=NA,
					  ...
					  legend.profile = "full",
					  legend.only = FALSE,
					  legend.titles = c(choro = NA, bubble.size = NA, bubble.col = NA, line.col = NA, line.lwd = NA),
					  legend.position = c("left", "top"),
					  legend.width = 0.3,
					  legend.max.height = 0.8,
					  legend.heights = c(choro = 0.3, hist = 0.25, bubble.size = 0.15, bubble.col = 0.3, line.col = 0.3, line.lwd = 0.15),
					  legend.config = c("hist", "choro", "bubble.size", "bubble.col", "line.col", "line.lwd"),
