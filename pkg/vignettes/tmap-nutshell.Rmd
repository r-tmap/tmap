...
```{r, fig.height=5}
qtm(Europe, fill="gdp_cap_est", text="iso_a3", text.size="AREA", root=5, title="GDP per capita", 
...
tm_shape(metro) +
	...
	tm_bubbles("X2010", "red", border.col = "black", border.lwd=1, size.lim = c(0, 11e6), sizes.legend = seq(2e6,10e6, by=2e6)) +
tm_shape(Europe) +
	tm_text("name", size="area", scale=1.5, root=8, size.lowerbound = .40, 
