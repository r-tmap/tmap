...
With the tmap package, thematic maps can be generated with great flexability. The syntax for creating plots is very similar to that of `ggplot2`. The complete workflow of reading ESRI shape files, setting the proper projection, and appending data is embedded in this package by several convenient functions.
...
Functions that are in experimental stage:
