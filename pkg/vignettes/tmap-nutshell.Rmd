...
tm_shape(metro) +
	...
	tm_bubbles("pop2010", "red", border.col = "black", border.lwd=1, size.lim = c(0, 11e6), sizes.legend = seq(2e6,10e6, by=2e6), title.size="City Population") +
tm_shape(Europe) +
...
(tm <- tm_shape(World) +
	tm_fill() +
	tm_borders() +
tm_layout(bg.color = "lightblue", outer.bg.color = "gold", outer.margins=c(.05,0,.05,0), inner.margins=c(0,0,.02,0), asp=0))
```
