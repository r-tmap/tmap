...
|[`tm_polygons`](../html/tm_polygons.html) | Combination of `tm_fill` and `tm_borders` | col |
...
Notice that this plot has a different layout than the previous. In the last plot, panels are used, and the common legend is shown next to the maps. These options can be changed with the arguments `panel.show` and `legend.outside` of [`tm_layout`](../html/tm_layout.html).
