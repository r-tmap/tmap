...
\Plainauthor{Martijn Tennekes} %% comma-separated
\Plaintitle{Creating thematic maps with the R package tmap} %% without formatting
\Shorttitle{Creating thematic maps with the R package tmap} %% a short title (if necessary)

%% an abstract and keywords
\Abstract{
  The R package tmap is open source software to 
