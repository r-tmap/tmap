...
tm_shape(World) + tm_polygons("HPI", fill.legend = tm_legend(position = tm_pos_auto_out(pos.h= "right", pos.v = "bottom", just.h = "left", just.v = "right")))
tm_shape(World) + tm_polygons("HPI", fill.legend = tm_legend(position = tm_pos_auto_out(pos.h= "right", pos.v = "bottom", just.h = "center", just.v = "center")))
tm_shape(World) + tm_polygons("HPI", fill.legend = tm_legend(position = tm_pos_auto_out(pos.h= "right", pos.v = "bottom", just.h = "right", just.v = "bottom")))
```
...
tm_shape(World) + tm_polygons("HPI", col = "economy") + tm_layout(legend.position = tm_pos_out("center", "center", pos.h = "center", pos.v = "center", just.h = "right", just.v = "bottom"))
tm_shape(World) + tm_polygons("HPI", col = "economy", col.legend = tm_legend(position = tm_pos_in(just.h = "right"))) + tm_layout(legend.position = tm_pos_out("center", "center", pos.h = "center", pos.v = "center"))
tm_shape(World) + tm_polygons("HPI", col = "economy", col.legend = tm_legend(position = tm_pos_in(just.h = "right"))) + tm_layout(legend.position = tm_pos_out("center", "center", pos.h = "center", pos.v = "center"))
tm_shape(World) + tm_polygons("HPI", col = "economy")
```
...
```{r}
tm_shape(World) + tm_polygons("HPI", col = "economy") + tm_title("Test1234")
```
