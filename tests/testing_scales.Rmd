...
```{r}
tm_shape(Africa) +
tm_symbols(size = "gdp_cap_est", size.scale = tm_scale_continuous(limits = c(0, 20000), ticks = c(5000,7500, 20000, 30000)))
```


```{r}
tm_shape(Africa) +
tm_symbols(size = "gdp_cap_est", size.scale = tm_scale_log10(limits = c(0, 20000), ticks = c(5000,7500, 20000)))
```
