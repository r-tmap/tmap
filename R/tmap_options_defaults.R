...
.defaultTmapOptions = structure(
	list(
		...
		label.format = list(
			...
			big.num.abbr = c(mln = 6, bln = 9, trn = 12, qdn = 15, qnt = 18),
			prefix = "",
			suffix = "",
			text.separator = "-",
			text.less.than = "<",
		...
		legend.settings.portrait = list(item.height = c(rect = 1.2, symbols = 1, gradient = 3, lines = 1.2, text = 1.2, bivariate = 1.2),
												 ...
												 xlab.align = "left",
												 ylab.align = "center",
												 ticks = list(rect = list(), symbols = list(), gradient = list(c(0.85, 1.1)), lines = list(), text = list(), bivariate = list()),
												 ticks.disable.na = c(rect = FALSE, symbols = FALSE, gradient = TRUE, lines = FALSE, text = FALSE, bivariate = TRUE),
												 ticks.col = NA,
												 ticks.lwd = 1,
												 margins = c(0.4, 0.4, 0.4, 0.4),
												 item_text.margin = c(gradient = 0.5, 0.25)),
		legend.settings.landscape = list(item.height = c(rect = 1, symbols = 1, gradient = 1.2, lines = 1, text = 1),
												  ...
												  xlab.align = "left",
												  ylab.align = "center",
												  ticks = list(rect = list(), symbols = list(), gradient = list(c(0.85, 1.1)), lines = list(), text = list()),
...
styles = list(
	v3 = list(
		...
		legend.frame = FALSE,
		legend.frame.r = 0,
		legend.settings.portrait = list(item.height = c(rect = 1, symbols = 1, gradient = 1, bivariate = 1),
