...
.defaultTmapOptions = structure(
	list(
		...
		component_general.height = 3,
		component_general.width = 3,
		component_general.margins = c(0.2, 0.2, 0.2, 0.2),
		component_general.dpi = 300,
		component_general.between_margin = 0.2,
		component_general.stack = "vertical",
		component_general.position = tm_pos_in(pos.h = "right", pos.v = "bottom", align.h = "right", align.v = "top", just.h = "left", just.v = "bottom"),
		component_general.frame = NA,
		component_general.frame.lwd = 1,
		component_general.frame.r = 2,
		component_general.group.frame = TRUE,
		component_general.resize_as_group = FALSE,
