...
#' @param facet.max Maximum number of facets in a static plot (rows x columns); animation frames are not counted.
#' @param facet_levels.max Maximum number of facet levels processed across all faceting dimensions, animation frames included (rows x columns x frames). Default `1e5`.
