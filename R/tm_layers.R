tm_polygons = function(fill = tm_const("fill.polygons"), 
	...
	tm_element_list(tm_element(
		...
		mapping.aes = list(fill = tmapScale(aes = "fill.polygons",
											value = fill,
											scale = fill.scale,
											legend = fill.legend,
											free = fill.free),
						   col = tmapScale(aes = "fill.polygons",
						   				value = col,
						   				scale = col.scale,
						   				legend = col.legend,
						   				free = col.free),
						   lwd = tmapScale(aes = "fill.polygons",
						   				value = lwd,
						   			  scale = lwd.scale,
						   			  legend = lwd.legend,
						   			  free = lwd.free),
						   lty = tmapScale(aes = "fill.polygons",
						   				value = lty,
						   			  scale = lty.scale,
						   			  legend = lty.scale,
						   			  free = lty.scale),
						   fill_alpha = tmapScale(aes = "fill.polygons",
						   					   value = fill_alpha,
						   					 scale = fill_alpha.scale,
						   					 legend = fill_alpha.scale,
						   					 free = fill_alpha.free),
						   col_alpha = tmapScale(aes = "fill.polygons",
						   					  value = col_alpha,
						   					 scale = col_alpha.scale,
						   					 legend = col_alpha.scale,
						   					 free = col_alpha.free)),
