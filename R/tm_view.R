...
#' @param set.view numeric vector or three that determines the view: lng, lat, and zoom (see \code{\link[leaflet:setView]{setView}}). Only applicable if \code{bbox} is not specified
