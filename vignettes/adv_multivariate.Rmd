...
Usually we specify a data-driven map variable with **one** data variable (see [vignette about map variables](https://r-tmap.github.io/tmap/articles/basics_vv)). However, in several use cases, it is useful to use a few data variables for one map variables.
