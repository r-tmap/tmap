...
See [`vignette("tmap-changes-v2")`](../doc/tmap-changes-v2.html) for changes in version 2.0, which is recommended for people who have read the JSS article. For people who are new to tmap, see [`vignette("tmap-getstarted")`](../doc/tmap-getstarted.html).
