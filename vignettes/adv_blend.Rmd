...
We map the gradient with a continuous black-to-white scale, so a value of `1` is white (top) and `0` is black (bottom). With the default `"over"`, the gradient simply covers the rainbow:
