...
* Specification of map variables. For new map variable, options need to be added.
* Spatial transformation function needs to be specified: e.g. should centroids be used?
* The mapping between map variables and (standard) visual or transformation parameters.
