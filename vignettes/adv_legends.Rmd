...
This vignettes builds on the [introduction vignette about legends](https://r-tmap.github.io/tmap/articles/basics_legends) and about [scales](https://r-tmap.github.io/tmap/articles/basics_scales)
...
This method, where visual variables are passed on via `tm_legend` will be covered in the section about [setting visual values](https://r-tmap.github.io/tmap/articles/adv_legends#setting-visual-values).
