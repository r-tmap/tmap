...
Most map variables are *visual*, e.g. polygon fill or symbol size. However, tmap also facilitates *transition* map variables. These variables will alter spatial geometries in a data-driven way. The difference is that a visual map variable only changes the appearance of a geometry (polygon fill color or symbol size), but a transition map variable changes the geometry itself.
