...
Such a geometry can be of type spatial point(s), line(s) or polygon(s) or any combination of these in a 'geometrycollection' (see [`vignette("sf1")`](https://cran.rstudio.com/web/packages/sf/vignettes/sf1.html)).
...
A list tmap options can be retrieved or options can be set with the function `tmap_options`. 
