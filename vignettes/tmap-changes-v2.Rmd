...
An `sf` (**s**imple **f**eatures) object has a less complex structure than `sp` objects. 
...
Such a geometry can be a spatial point(s), line(s), polygon(s), or any combination.
